    ...
    return (
      <Html lang="ar" className="light">
        <Head>
          ...
          {/* Icons */}
          <link rel="apple-touch-icon" sizes="152x152" href="/public/touch-icon/touch-icon-ipad.png" />
          <link rel="apple-touch-icon" sizes="180x180" href="/public/touch-icon/touch-icon-iphone-retina.png" />
          <link rel="apple-touch-icon" sizes="167x167" href="/public/touch-icon/touch-icon-ipad-retina.png" />
          <link rel="icon" type="image/png" sizes="32x32" href="/public/favicon-32x32.png" />
          <link rel="icon" type="image/png" sizes="16x16" href="/public/favicon-16x16.png" />
          <link rel="shortcut icon" href="/public/favicon.ico" />
          <link rel="mask-icon" href="/public/safari-pinned-tab.svg" color="#336a86" />
          ...
          <meta name="twitter:image" content="/public/icon-192x192.png" />
