...
const Index = () => {
    ...
    const { queryString, updateQuery } = useQueryString({ page: currentPage, limit, type: "marketToStore" });
            ...
            },
            {
                ...
                cell: (row) => (
                    <div className="flex gap-2">
                        <Button
                            onClick={() => router.push(`/store/return-from-market/add-update?id=${row?.id}`)}
    ...
    const handleExportExcel = async () => {
        ...
        await exportExcel(tableData, columns, t("return_from_market_key"), handleMessage);
        setTimeout(() => {
            ...
            <div className="min-h-full bg-gray-100 rounded-md dark:bg-gray-700">
                ...
                <ServerTable
                    ...
                    actions={
                        <Actions
                            addMsg={t("add_key")}
                            onClickAdd={() => router.push("/store/return-from-market/add-update")}
