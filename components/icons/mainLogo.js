...
const MainLogo = forwardRef((props, ref) => {
  return (
    <svg
      ...
      {...props}
    >
      <g transform="matrix(1,0,0,1,-1.2119569556914485,-1.251484874352684)">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          xmlnsXlink="http://www.w3.org/1999/xlink"
          viewBox="0 0 396 107"
        ...
        >
          <g
            id="tight-bounds"
            transform="matrix(1,0,0,1,0.23996747722691225,0.248015671154576)"
          >
            <svg
              viewBox="0 0 395.52 106.50380371046852"
              height={106.50380371046852}
              width={395.52}
              {...props}
            >
              <g>
                ...
                >
                  <g>
                    <svg
                      viewBox="0 0 486.4529842161224 130.98981883425753"
                      height={106.50380371046852}
                      width={395.52}
                      {...props}
                    >
                      <g transform="matrix(1,0,0,1,90.9329842161224,0)">
                        <svg
                          viewBox="0 0 395.52 130.98981883425753"
                          height={130.98981883425753}
                          width={395.52}
                          {...props}
                        >
                          <g id="textblocktransform">
                            ...
                            >
                              <g>
                                ...
                                >
                                  <path
                                    d="M394.594 28.095C392.735 14.498 387.435 10.718 387.435 10.718 371.165-3.286 350.86-0.268 332.619 1.744 300.414 1.826 268.339 4.817 236.208 6.422 168.767 6.666 100.749 2.642 33.643 12.567 27.339 15.613-6.54 13.166 1.121 29.835 3.129 36.77 10.456 44.465 10.232 50.828 11.236 51.943 12.631 49.387 13.226 50.992 15.309 55.315 18.711 53.276 21.501 55.832 17.614 62.658 20.403 68.341 23.062 74.296 18.377 75.846 12.371 75.112 9.675 80.252 9.396 83.977 7.89 83.27 6.235 83.107 5.026 82.998 2.59 83.406 2.999 84.575 4.394 88.573-1.594 90.884 2.162 94.8-0.422 99.042 3.948 102.713 3.353 107.309 3.278 108.234 3.687 109.022 4.338 109.24 7.22 110.409 3.018 112.693 3.464 115.168 33.029 132.082 65.104 120.389 95.394 128.167 103.259 122.728 97.346 130.097 100.489 128.955 102.943 127.623 104.728 133.143 107.499 130.016 107.927 129.118 107.276 126.997 108.8 127.405 109.6 127.623 110.307 127.568 110.418 126.317 110.586 124.441 109.117 125.61 108.726 124.631 112.947 119.682 111.906 131.457 115.866 130.967 115.68 129.526 114.528 127.459 116.889 127.731 119.232 125.665 119.306 123.952 121.389 128.602 121.463 129.608 121.835 130.315 122.43 130.804 128.938 125.746 135.409 132.599 142.233 130.315 146.417 127.813 150.433 131.674 154.672 130.723 156.16 129.961 157.666 128.602 159.098 130.886 176.632 131.375 195.319 129.336 211.943 130.967 256.364 127.922 303.836 132.218 350.674 128.194 361.719 126.644 373.192 124.441 383.958 122.673 383.958 122.673 392.679 117.833 392.679 96.078S394.538 77.043 394.817 59.721C395.096 42.399 396.398 41.692 394.538 28.095Z"
                                    opacity={1}
                                    fill="#336a86"
                      ...
                      <g transform="matrix(1,0,0,1,0,5.1522662074807855)">
                        <svg
                          viewBox="0 0 72.39429347300621 120.68528641929596"
                          height={120.68528641929596}
                          width={72.39429347300621}
                          {...props}
                        >
                          <g>
                            <svg
                              ...
                              x={0}
                              y={0}
                              viewBox="30.827083519658654 18.03837341094086 38.3454022308225 63.92390379243734"
                              ...
                              {...props}
                            >
                              <g fill="#336a86" data-fill-palette-color="accent">
                                <path
                                  d="M43.798 18.06c-0.251 0.057-0.502 0.254-0.586 0.509l-11.275 31.77c-0.167 0.481 0.251 1.076 0.754 1.076h8.4L30.877 80.892c-0.139 0.34 0.028 0.765 0.307 0.963 0.307 0.17 0.726 0.142 0.977-0.113l36.837-40.406c0.419-0.453 0.028-1.359-0.586-1.359H53.956l9.377-20.812c0.224-0.481-0.224-1.132-0.754-1.104H43.966C43.91 18.031 43.854 18.031 43.798 18.06L43.798 18.06zM44.496 19.645h16.856l-9.349 20.812c-0.195 0.481 0.195 1.104 0.726 1.104h13.87L33.584 77.777l9.377-26.9c0.167-0.481-0.251-1.048-0.753-1.075h-8.4L44.496 19.645 44.496 19.645z"
                                  fill="#336a86"
                                  data-fill-palette-color="accent"
                                />
                              </g>
