...
export const handlePostRequest = async (data, res) => {
  const { name, description, category, price, quantityInStock, quantityInStore, quantityInMarket, unit, createdBy } = data;
...
export const handlePutRequest = async (data, res) => {
  const { id, name, description, category, price, quantityInStock, quantityInStore, quantityInMarket, unit, lastUpdatedBy } = data;
